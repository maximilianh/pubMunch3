...
class EncodingTestCase(unittest.TestCase):
    ...
    def testCdataCharacters(self):
        self.assertEqual("<style>&amacr;", serialize_html([["StartTag", "http://www.w3.org/1999/xhtml", "style", {}],
                                                            ["Characters", "\u0101"]],
                                                           {"encoding": "iso-8859-1"}))

    def testCharacters(self):
        self.assertEqual("&amacr;", serialize_html([["Characters", "\u0101"]],
                                                    {"encoding": "iso-8859-1"}))
    ...
    def testAttributeValue(self):
        self.assertEqual("<span potato=&amacr;>", serialize_html([["StartTag", "http://www.w3.org/1999/xhtml", "span",
